...
import 'package:Para/widgets/view_notification_details.dart';
...
class _ActivityItemsState extends State<ActivityItems> {
  ...
  buildTextConfiguration() {
    if (widget.activity.type == "like") {
      return "aime votre photo.";
    } else if (widget.activity.type == "follow") {
      return "vous suit désormais.";
    } else if (widget.activity.type == "comment") {
      return "a commenté '${widget.activity.commentData}'";
    } else {
      return "Erreur : Type inconnu '${widget.activity.type}'";
    }
  }
